...
function MarketingPage() {
  return (
    <div className='bg-gradient-to-b from-black to-sky-500 h-[calc(100vh-56px)]'>
      <div className=' flex justify-center items-center flex-col mx-auto max-w-screen-2xl px-4 text-gray-200'>
        ...
        <div className=' flex  items-center justify-center gap-12 '>
          <div className='flex-1 flex flex-col gap-32'>
            ...
            <div>
              <p>
                • Easy to use, simple to understand, with powerful tools and
                more.
              </p>
              <Spacer size={6} />
              <p>
              ...
              <Spacer size={6} />
              <p>
                • Create Lists , Tasks and Subtasks, and assign them to your
                team members.
              </p>
              <Spacer size={6} />
              <p>
