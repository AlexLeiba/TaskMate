...
export function Navbar() {
  ...
  return (
    <div className='fixed top-0 w-full    border-b shadow-sm bg-slate-100 z-50 dark:bg-gray-800'>
      <div className='w-full mx-auto max-w-screen-2xl px-4 flex items-center justify-between h-14  '>
